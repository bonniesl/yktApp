...
//    ExerciseInfoController *eController = [[ExerciseInfoController alloc]init];
//    UINavigationController *navi = [[UINavigationController alloc]initWithRootViewController:eController];
